    ...
    <section className="py-20 bg-gradient-to-br from-sky-50 via-white to-orange-50">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <p className="text-center text-gray-600 mb-12">
          Real experiences from families who trust KiddyLearno with their child’s learning journey.
        </p>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {reviews.map((review, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-white rounded-2xl shadow-lg p-8 flex flex-col hover:shadow-2xl transition relative"
              >
                ...
                <p
                  className={`text-gray-700 text-sm leading-relaxed mb-6 transition-all duration-300 ${
                ...
                <button
                  ...
                  className="text-sky-600 text-sm font-medium hover:underline mb-4 self-start"
                >
                  {isExpanded ? "Show Less" : "Read More"}
                </button>

                <div className="flex gap-1 text-yellow-400 mt-auto">
